...
*HashMap*实现了*Map*接口，即允许放入`key`为`null`的元素，也允许插入`value`为`null`的元素；除该类未实现同步外，其余跟`Hashtable`大致相同；
...
![HashMap_base](https://github.com/CarpenterLee/JCFInternals/raw/master/PNGFigures/HashMap_base.png)
...
![HashMap_getEntry](https://github.com/CarpenterLee/JCFInternals/raw/master/PNGFigures/HashMap_getEntry.png)
...
JDK 1.8改为了尾插法：为了避免出现逆序且链表死循环的问题（JDK1.7的HashMap扩容导致死循环）

![HashMap_addEntry](https://github.com/CarpenterLee/JCFInternals/raw/master/PNGFigures/HashMap_addEntry.png)
...
![HashMap_removeEntryForKey](https://github.com/CarpenterLee/JCFInternals/raw/master/PNGFigures/HashMap_removeEntryForKey.png)
